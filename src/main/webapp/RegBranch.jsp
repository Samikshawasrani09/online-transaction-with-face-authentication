...
<div class="col-md-12"> <h2>Branch Registration</h2>
   <div class="form-group"> 
    <form method="post" name="frm" action="/RegBranch">
<table class="tblform">
<tr>
<td>Branch Name</td>
<td>
...
<tr>
             ...
             <tr><td>Address</td>
                ...
                <tr><td>Manager Name</td>
                    <td><input type="text"  name="manager" required class="form-control"></input></td>
                </tr>
                 <%
